...
{
    JLabel l1=new JLabel("Vehicle_Id");
    JLabel l2=new JLabel("Vehicle_name");
    JLabel l3=new JLabel("Vehicle_cost");
    JLabel l4=new JLabel("Vehicle_color");
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if(ae.getSource()==btn1)
        {
            try
            {
                st.execute("insert into Vehicles values ('"+t1.getText()+"','"+t2.getText()+"','"+t3.getText()+"','"+t4.getText()+"')");
                t1.setText("");
                t2.setText("");
                t3.setText("");
                t4.setText("");
        ...
        if(ae.getSource()==btn2)
        {
            try
            {
                ResultSet rs = st.executeQuery("Select * from Vehicles where Vehicle_Id="+t1.getText());
                if(rs.next()){
        ...
        if(ae.getSource()==btn3)
        {
            try
            {
                st.execute("Delete from Vehicles where Vehicle_Id="+t1.getText());
                t1.setText("");
                t2.setText("");
                t3.setText("");
                t4.setText("");
        ...
        if(ae.getSource()==btn4)
        {
            try
            {
                st.execute("Update Vehicles set Vehicle_name='"+t2.getText()+"', Vehicle_cost='"+t3.getText()+"', Vehicle_color='"+t4.getText()+"', where Vehicle_Id="+t1.getText());
                t1.setText("");
                t2.setText("");
                t3.setText("");
                t4.setText("");
